...
var findUsuarios = $("#findUsuarios");

// Funciones para renderizar usuarios

const renderizarUsuarios = function (personas) {
  // [{} , {},..]
...
const renderizarMensajes = function (mensaje, yo) {
  var html = "";
...
// const buscarUsuarios = function (personaBuscada) {
...
//     personaBuscada[0].id +
//     '"href="javascript:void(0)"><img src="assets/images/users/1.jpg" alt="user-img" class="img-circle" /><span>' +
//     personaBuscada[0].nombre +
//     '<small class="text-success">online</small></span></a>';
//   html += "</li>";

//   findUsuarios.html(html);
// };
...
findUsuarios.on("input", function () {
  var nombre = findUsuarios.val().trim();

  socket.emit("buscarPersona", { nombre }, function (resp) {
